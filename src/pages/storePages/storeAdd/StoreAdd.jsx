        ...
        <>
            <form className="mx-auto max-w-screen-md mt-10" onSubmit={handleAdd}>
                <div className="space-y-12">
                    <div className="pb-0">
                        <h2 className="font-semibold leading-7 text-gray-900 text-3xl">Add Store</h2>
                            ...
                            <div className="col-span-3">
                                ...
                                <div className="mt-2 flex items-center gap-x-3">
                                    {photo ? (
                                        ...
                                        <PlusCircleIcon className="h-12 w-12 text-gray-300" aria-hidden="true"/>
                                    )}
                                    <button
                                        type="button"
